#!/usr/bin/env python3
"""
CIFAR-10 Classification with AKOrN using ReadoutOnlyMyAKOrN + ResNet.
...
def main():
    ...
    if not args.no_wandb:
        ...
        # run_name = f"{config['experiment_name']}_T{args.T}_gamma{args.gamma}_job{job_id}"
